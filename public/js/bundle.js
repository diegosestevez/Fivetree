      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New account successfully created!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1000);
            }
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Adds the marker
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourID) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KB6lzEzOEUXHhbw9Lvz3ElMFNnTQGYD2voEOS65enDHks2wK1bqScbHCVsUyjhRPOaVZ3CPxXDZjfTritjoDgdR00PCSyxLVU'); // Stripe() is activated from from <script src="https://js.stripe.com/v3/"></script> tag in the html
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // this is used to handle form data such as files for multer on the backend in place of enctype='multipart/form-data' that you would put in the <form> tags
